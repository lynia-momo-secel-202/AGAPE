describe 'Morris.Line', ->
  ...
  it 'should make point styles customizable', ->
    ...
    chart.pointStrokeWidthForFilieres(0).should.equal 1
    chart.pointStrokeColorForFilieres(0).should.equal red
    chart.pointStrokeWidthForFilieres(1).should.equal 2
    chart.pointStrokeColorForFilieres(1).should.equal blue
  ...
  describe 'rendering lines', ->
    ...
    it 'should make line width customizable', ->
      ...
      chart.lineWidthForFilieres(0).should.equal 1
      chart.lineWidthForFilieres(1).should.equal 2
