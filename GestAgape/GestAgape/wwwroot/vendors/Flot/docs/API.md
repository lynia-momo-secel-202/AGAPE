...
Flot to keep track of its state, so be careful.
  ...
  - computeRangeForDataFilieres(series, force)
  ...
  - adjustFilieresDataRange(series, range)
...
hooks in the plugins bundled with Flot.
 ...
 - adjustFilieresDataRange [phase 4]
...
* [jquery.flot.drawFilieres.js](drawFilieres.md)
