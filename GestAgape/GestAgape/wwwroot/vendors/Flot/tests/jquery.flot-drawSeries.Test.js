...
describe('drawFilieres', function() {

    describe('drawFilieresLines', function() {
        var minx = 0, maxx = 200, miny = 0, maxy = 100,
            series, ctx, plotWidth, plotHeight, plotOffset,
            drawFilieresLines = jQuery.plot.drawFilieres.drawFilieresLines,
            getColorOrGradient;
        ...
        it('should draw nothing when the values are null', function () {
            ...
            drawFilieresLines(series, ctx, plotOffset, plotWidth, plotHeight, null, getColorOrGradient);
    ...
    describe('drawFilieresPoints', function() {
        var minx = 0, maxx = 200, miny = 0, maxy = 100,
            series, ctx, plotWidth, plotHeight, plotOffset,
            drawFilieresPoints = jQuery.plot.drawFilieres.drawFilieresPoints,
        ...
        it('should draw nothing when the values are null', function () {
            ...
            drawFilieresPoints(series, ctx, plotOffset, plotWidth, plotHeight, null, getColorOrGradient);
        ...
        it('should draw custom symbols given by name for values', function () {
            ...
            drawFilieresPoints(series, ctx, plotOffset, plotWidth, plotHeight, {'dollar': dollar}, getColorOrGradient);
        ...
        it('should draw custom symbols given by function for values', function () {
            ...
            drawFilieresPoints(series, ctx, plotOffset, plotWidth, plotHeight, dollar, getColorOrGradient);
    ...
    describe('drawFilieresBars', function() {
        var minx = -200, maxx = 200, miny = -100, maxy = 100,
            series, ctx, plotWidth, plotHeight, plotOffset,
            drawFilieresBars = jQuery.plot.drawFilieres.drawFilieresBars,
            getColorOrGradient;
        ...
        it('should draw nothing when the values are null', function () {
            ...
            drawFilieresBars(series, ctx, plotOffset, plotWidth, plotHeight, null, getColorOrGradient);
