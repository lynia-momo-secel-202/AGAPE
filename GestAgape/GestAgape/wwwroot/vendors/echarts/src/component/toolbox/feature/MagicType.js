define(function(require) {
    ...
    proto.onclick = function (ecModel, api, type) {
        ...
        var generateNewFilieresTypes = function (seriesModel) {
            var seriesType = seriesModel.subType;
            var seriesId = seriesModel.id;
            var newFilieresOpt = seriesOptGenreator[type](
                seriesType, seriesId, seriesModel, model
            );
            if (newFilieresOpt) {
                // PENDING If merge original option?
                zrUtil.defaults(newFilieresOpt, seriesModel.option);
                newOption.series.push(newFilieresOpt);
            }
            // Modify boundaryGap
