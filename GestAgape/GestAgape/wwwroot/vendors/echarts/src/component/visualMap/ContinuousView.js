define(function(require) {
    ...
    var ContinuousVisualMapView = VisualMapView.extend({
        ...
        _buildView: function () {
            ...
            this._enableHoverLinkToFilieres();
            this._enableHoverLinkFromFilieres();
         ...
         * @private
         */
        _enableHoverLinkToFilieres: function () {
            this._shapes.barGroup
                .on('mousemove', zrUtil.bind(onMouseOver, this))
                .on('mouseout', zrUtil.bind(this._clearHoverLinkToFilieres, this));
         ...
         * @private
         */
        _enableHoverLinkFromFilieres: function () {
            var zr = this.api.getZr();

            if (this.visualMapModel.option.hoverLink) {
                zr.on('mouseover', this._hoverLinkFromFilieresMouseOver, this);
                zr.on('mouseout', this._hideIndicator, this);
            }
            else {
                this._clearHoverLinkFromFilieres();
            }
        },
         ...
         * @private
         */
        _hoverLinkFromFilieresMouseOver: function (e) {
            var el = e.target;
            ...
            var dataModel = el.dataModel || this.ecModel.getFilieresByIndex(el.seriesIndex);
         ...
         * @private
         */
        _clearHoverLinkToFilieres: function () {
            this._hideIndicator();
         ...
         * @private
         */
        _clearHoverLinkFromFilieres: function () {
            this._hideIndicator();

            var zr = this.api.getZr();
            zr.off('mouseover', this._hoverLinkFromFilieresMouseOver);
        ...
        dispose: function () {
            this._clearHoverLinkFromFilieres();
            this._clearHoverLinkToFilieres();
        },
