...
define(function(require) {
    ...
    var VisualMapModel = echarts.extendComponentModel({
         ...
         * @protected
         */
        resetTargetFilieres: function (newOption, isInit) {
            var thisOption = this.option;
            var allFilieresIndex = thisOption.seriesIndex == null;
            thisOption.seriesIndex = allFilieresIndex
                ? [] : modelUtil.normalizeToArray(thisOption.seriesIndex);

            allFilieresIndex && this.ecModel.eachFilieres(function (seriesModel, index) {
         ...
         * @public
         */
        eachTargetFilieres: function (callback, context) {
            zrUtil.each(this.option.seriesIndex, function (seriesIndex) {
                callback.call(context, this.ecModel.getFilieresByIndex(seriesIndex));
            }, this);
        },
