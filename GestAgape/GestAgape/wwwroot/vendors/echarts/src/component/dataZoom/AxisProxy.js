...
define(function(require) {
    ...
    AxisProxy.prototype = {
         ...
         */
        getTargetFilieresModels: function () {
            var seriesModels = [];

            this.ecModel.eachFilieres(function (seriesModel) {
        ...
        reset: function (dataZoomModel) {
            ...
            var dataExtent = this._dataExtent = calculateDataExtent(
                this._dimName, this.getTargetFilieresModels()
            );
        ...
        filterData: function (dataZoomModel) {
            ...
            var axisDim = this._dimName;
            var seriesModels = this.getTargetFilieresModels();
