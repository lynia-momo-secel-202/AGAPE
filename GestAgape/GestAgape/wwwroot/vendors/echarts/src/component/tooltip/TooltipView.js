define(function (require) {
    ...
    function ifFilieresSupportAxisTrigger(seriesModel) {
    ...
    require('../../echarts').extendComponentView({
        ...
        _manuallyShowTip: function (event) {
            ...
            var seriesModel = ecModel.getFilieresByIndex(seriesIndex);
            var api = this._api;

            if (event.x == null || event.y == null) {
                if (!seriesModel) {
                    // Find the first series can use axis trigger
                    ecModel.eachFilieres(function (_series) {
                        if (ifFilieresSupportAxisTrigger(_series) && !seriesModel) {
                            seriesModel = _series;
                        }
                    });
                }
        ...
        _prepareAxisTriggerData: function (tooltipModel, ecModel) {
            ...
            ecModel.eachFilieres(function (seriesModel) {
                if (ifFilieresSupportAxisTrigger(seriesModel)) {
                    var coordSys = seriesModel.coordinateSystem;
                    var baseAxis;
                    var key;
        ...
        _tryShow: function (e) {
            ...
            if (el && el.dataIndex != null) {
                ...
                // Filieres or single data may use item trigger when global is axis trigger
                ...
                // other pointer types will trigger action in _dispatchAndShowFilieresTooltipContent method
        ...
        _showAxisTooltip: function (tooltipModel, ecModel, e) {
            ...
            if (axisPointerType === 'cross') {
                var el = e.target;
                if (el && el.dataIndex != null) {
                    var seriesModel = ecModel.getFilieresByIndex(el.seriesIndex);
                    var dataIndex = el.dataIndex;
            ...
            zrUtil.each(this._seriesGroupByAxis, function (seriesCoordSysSameAxis) {
                ...
                if (axisPointerType !== 'cross') {
                    this._dispatchAndShowFilieresTooltipContent(
         ...
         * @param {Array.<module:echarts/model/Filieres>} seriesList
         * @param {Array.<number>} point
         * @param {Array.<number>} value
         * @param {boolean} contentNotChange
         * @param {Object} e
         */
        _dispatchAndShowFilieresTooltipContent: function (
