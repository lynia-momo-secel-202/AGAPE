...
define(function (require) {
    ...
    Radar.prototype.update = function (ecModel, api) {
        ...
        ecModel.eachFilieresByType('radar', function (radarFilieres, idx) {
            if (radarFilieres.get('coordinateSystem') !== 'radar'
                || ecModel.getComponent('radar', radarFilieres.get('radarIndex')) !== radarModel
            ) {
                return;
            }
            var data = radarFilieres.getData();
            zrUtil.each(indicatorAxes, function (indicatorAxis) {
    ...
    Radar.create = function (ecModel, api) {
        ...
        ecModel.eachFilieresByType('radar', function (radarFilieres) {
            if (radarFilieres.get('coordinateSystem') === 'radar') {
                // Inject coordinate system
                radarFilieres.coordinateSystem = radarList[radarFilieres.get('radarIndex') || 0];
            }
        });
        return radarList;
    };
