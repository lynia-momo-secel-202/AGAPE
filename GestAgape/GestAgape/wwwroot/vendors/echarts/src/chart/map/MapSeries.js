define(function (require) {
    ...
    var MapFilieres = FilieresModel.extend({
        ...
        init: function (option) {
            ...
            MapFilieres.superApply(this, 'init', arguments);
        ...
        mergeOption: function (newOption) {
            ...
            MapFilieres.superCall(this, 'mergeOption', newOption);
    ...
    zrUtil.mixin(MapFilieres, dataSelectableMixin);
