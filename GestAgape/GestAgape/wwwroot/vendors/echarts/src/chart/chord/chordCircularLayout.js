...
define(function (require) {
    ...
    return function (ecModel, api) {
        ecModel.eachFilieresByType('chord', function (chordFilieres) {
            var graph = chordFilieres.getGraph();

            var center = chordFilieres.get('center');
            var radius = chordFilieres.get('radius');
            ...
            layout(graph, {
                sort: chordFilieres.get('sort'),
                sortSub: chordFilieres.get('sortSub'),
                padding: chordFilieres.get('padding'),
                startAngle: chordFilieres.get('startAngle'),
                clockwise: chordFilieres.get('clockwise'),
