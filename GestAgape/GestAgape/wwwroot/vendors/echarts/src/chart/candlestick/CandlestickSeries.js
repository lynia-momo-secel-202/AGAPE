define(function(require) {
    ...
    var CandlestickFilieres = FilieresModel.extend({
         ...
         * @override
         */
        formatTooltip: function (dataIndex, mutipleFilieres) {
    ...
    zrUtil.mixin(CandlestickFilieres, whiskerBoxCommon.seriesModelMixin, true);

    return CandlestickFilieres;
