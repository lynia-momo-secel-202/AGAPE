define(function (require) {
    ...
    var GraphFilieres = require('../../echarts').extendFilieresModel({

        type: 'series.graph',

        init: function (option) {
            GraphFilieres.superApply(this, 'init', arguments);
        ...
        mergeOption: function (option) {
            GraphFilieres.superApply(this, 'mergeOption', arguments);
        ...
        mergeDefaultAndTheme: function (option) {
            GraphFilieres.superApply(this, 'mergeDefaultAndTheme', arguments);
        ...
        formatTooltip: function (dataIndex, multipleFilieres, dataType) {
            if (dataType === 'edge') {
                ...
                return GraphFilieres.superApply(this, 'formatTooltip', arguments);
            }
        },
