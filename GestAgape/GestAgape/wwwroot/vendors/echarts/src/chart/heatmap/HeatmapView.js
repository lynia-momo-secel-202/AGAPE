define(function (require) {
    ...
    return require('../../echarts').extendChartView({
        ...
        render: function (seriesModel, ecModel, api) {
            var visualMapOfThisFilieres;
            ecModel.eachComponent('visualMap', function (visualMap) {
                visualMap.eachTargetFilieres(function (targetFilieres) {
                    if (targetFilieres === seriesModel) {
                        visualMapOfThisFilieres = visualMap;
                    }
                });
            });

            if (!visualMapOfThisFilieres) {
            ...
            if (coordSys.type === 'cartesian2d') {
                ...
                this._renderOnGeo(
                    coordSys, seriesModel, visualMapOfThisFilieres, api
                );
            }
        },
