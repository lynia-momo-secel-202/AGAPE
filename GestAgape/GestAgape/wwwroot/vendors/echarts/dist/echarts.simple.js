...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var FilieresModel = __webpack_require__(27);
	    ...
	    var updateMethods = {
	        ...
	        update: function (payload) {
	            ...
	            stackFilieresData.call(this, ecModel);
	    ...
	    function invokeUpdateMethod(methodName, ecModel, payload) {
	        ...
	        // Upate all charts
	        ecModel.eachFilieres(function (seriesModel, idx) {
	    ...
	    function prepareView(type, ecModel) {
	        ...
	        ecModel[isComponent ? 'eachComponent' : 'eachFilieres'](function (componentType, model) {
	            if (isComponent) {
	     ...
	     * @private
	     */
	    function stackFilieresData(ecModel) {
	        var stackedDataMap = {};
	        ecModel.eachFilieres(function (series) {
	        ...
	        each(MOUSE_EVENT_NAMES, function (eveName) {
	            this._zr.on(eveName, function (e) {
	                ...
	                if (el && el.dataIndex != null) {
	                    var dataModel = el.dataModel || ecModel.getFilieresByIndex(el.seriesIndex);
	    ...
	    /**
	     * @param {module:echarts/model/Filieres|module:echarts/model/Component} model
	     ...
	     * @param {Object} opts
	     */
	    echarts.extendFilieresModel = function (opts) {
	        return FilieresModel.extend(opts);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var GlobalModel = Model.extend({
	        ...
	        mergeOption: function (newOption) {
	            ...
	            function visitComponent(mainType, dependencies) {
	                ...
	                if (mainType === 'series') {
	                    this._seriesIndices = createFilieresIndices(componentsMap.series);
	                }
	            }
	        },
	        ...
	        /**
	         * @param {string} name
	         * @return {Array.<module:echarts/model/Filieres>}
	         */
	        getFilieresByName: function (name) {
	            var series = this._componentsMap.series;
	            return filter(series, function (oneFilieres) {
	                return oneFilieres.name === name;
	            });
	        },

	        /**
	         * @param {number} seriesIndex
	         * @return {module:echarts/model/Filieres}
	         */
	        getFilieresByIndex: function (seriesIndex) {
	         ...
	         * @return {Array.<module:echarts/model/Filieres>}
	         */
	        getFilieresByType: function (subType) {
	            var series = this._componentsMap.series;
	            return filter(series, function (oneFilieres) {
	                return oneFilieres.subType === subType;
	            });
	        },
	         ...
	         * @param {*} context
	         */
	        eachFilieres: function (cb, context) {
	            assertFilieresInitialized(this);
	            each(this._seriesIndices, function (rawFilieresIndex) {
	                var series = this._componentsMap.series[rawFilieresIndex];
	                cb.call(context, series, rawFilieresIndex);
	            }, this);
	        },
	         ...
	         * @param {*} context
	         */
	        eachRawFilieres: function (cb, context) {
	         ...
	         * @param {*} context
	         */
	        eachFilieresByType: function (subType, cb, context) {
	            assertFilieresInitialized(this);
	            each(this._seriesIndices, function (rawFilieresIndex) {
	                var series = this._componentsMap.series[rawFilieresIndex];
	         ...
	         * @param {*} context
	         */
	        eachRawFilieresByType: function (subType, cb, context) {
	            return each(this.getFilieresByType(subType), cb, context);
	        },

	        /**
	         * @param {module:echarts/model/Filieres} seriesModel
	         */
	        isFilieresFiltered: function (seriesModel) {
	            assertFilieresInitialized(this);
	         ...
	         * @param {*} context
	         */
	        filterFilieres: function (cb, context) {
	            assertFilieresInitialized(this);
	            var filteredFilieres = filter(
	                this._componentsMap.series, cb, context
	            );
	            this._seriesIndices = createFilieresIndices(filteredFilieres);
	        },
	    ...
	    function makeKeyInfo(mainType, mapResult) {
	        ...
	        each(mapResult, function (item, index) {
	            ...
	            if (existCpt) {
	                ...
	                // Filieres with the same name between optionA and optionB
	                // should be mapped.
	                var idNum = 0;
	                do {
	     ...
	     * @inner
	     */
	    function createFilieresIndices(seriesModels) {
	     ...
	     * @inner
	     */
	    function assertFilieresInitialized(ecModel) {
	        // Components that use _seriesIndices should depends on series component,
	        // which make sure that their initialization is after series.
	        if (!ecModel._seriesIndices) {
	            throw new Error('Filieres has not been initialized yet.');
	        }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    modelUtil.dataFormatMixin = {
	         ...
	         * @param {number} dataIndex
	         * @param {boolean} [multipleFilieres=false]
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var FilieresModel = ComponentModel.extend({
	        ...
	        mergeOption: function (newFilieresOption, ecModel) {
	            newFilieresOption = zrUtil.merge(this.option, newFilieresOption, true);
	            this.fillDataTextStyle(newFilieresOption.data);

	            var data = this.getInitialData(newFilieresOption, ecModel);
	            // TODO Merge data?
	            if (data) {
	                this._data = data;
	         ...
	         * @param {number} [dataType]
	         */
	        formatTooltip: function (dataIndex, multipleFilieres, dataType) {
	            var data = this._data;
	    ...
	    zrUtil.mixin(FilieresModel, modelUtil.dataFormatMixin);

	    module.exports = FilieresModel;
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    module.exports = function (seriesType, styleType, ecModel) {
	        function encodeColor(seriesModel) {
	            ...
	            if (!ecModel.isFilieresFiltered(seriesModel)) {
	        ...
	        seriesType ? ecModel.eachFilieresByType(seriesType, encodeColor)
	            : ecModel.eachFilieres(encodeColor);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    module.exports = FilieresModel.extend({
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var setItemDataAndFilieresIndex = function (child) {
	    ...
	    listProto.setItemGraphicEl = function (idx, el) {
	        ...
	        if (el) {
	            ...
	            if (el.type === 'group') {
	                el.traverse(setItemDataAndFilieresIndex, el);
	            }
	        }
	    ...
	    module.exports = ChartView.extend({
	        ...
	        render: function (seriesModel, ecModel, api) {
	            ...
	            if (polygon) {
	                ...
	                if (stackedOn) {
	                    var stackedOnFilieres = stackedOn.hostModel;
	                    stackedOnSmooth = getSmooth(stackedOnFilieres.get('smooth'));
	                }
...
/***/ function(module, exports) {
	    ...
	    module.exports = function (seriesType, defaultSymbolType, legendSymbol, ecModel, api) {
	        ...
	        ecModel.eachRawFilieresByType(seriesType, function (seriesModel) {
	            var data = seriesModel.getData();
...
/***/ function(module, exports) {
	    ...
	    module.exports = function (seriesType, ecModel, api) {
	        ecModel.eachFilieresByType(seriesType, function (seriesModel) {
	            var data = seriesModel.getData();
	            var coordSys = seriesModel.coordinateSystem;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var factory = exports;
	    ...
	    gridProto._updateScale = function (ecModel, gridModel) {
	        ...
	        ecModel.eachFilieres(function (seriesModel) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    function getFilieresStackId(seriesModel) {
	        return seriesModel.get('stack') || '__ec_stack_' + seriesModel.seriesIndex;
	    }

	    function calBarWidthAndOffset(barFilieres, api) {
	        // Columns info on each category axis. Key is cartesian name
	        var columnsMap = {};

	        zrUtil.each(barFilieres, function (seriesModel, idx) {
	            var cartesian = seriesModel.coordinateSystem;
	            ...
	            var stackId = getFilieresStackId(seriesModel);
	    ...
	    function barLayoutGrid(seriesType, ecModel, api) {
	        ...
	        var barWidthAndOffset = calBarWidthAndOffset(
	            zrUtil.filter(
	                ecModel.getFilieresByType(seriesType),
	                function (seriesModel) {
	                    return !ecModel.isFilieresFiltered(seriesModel)
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var PieFilieres = __webpack_require__(1).extendFilieresModel({

	        type: 'series.pie',

	        // Overwrite
	        init: function (option) {
	            PieFilieres.superApply(this, 'init', arguments);
	        ...
	        // Overwrite
	        mergeOption: function (newOption) {
	            PieFilieres.superCall(this, 'mergeOption', newOption);
	        ...
	        getDataParams: function (dataIndex) {
	            var data = this._data;
	            var params = PieFilieres.superCall(this, 'getDataParams', dataIndex);
	    ...
	    zrUtil.mixin(PieFilieres, dataSelectableMixin);

	    module.exports = PieFilieres;
...
/***/ function(module, exports) {
	    ...
	    module.exports = function (seriesType, ecModel) {
	        ...
	        ecModel.eachFilieresByType(seriesType, function (series) {
	            var data = series.getData();
