...
{
    public class InscriptionRepository : GenericRepository<Inscription>, IInscriptionRep
    {
        public InscriptionRepository(IdentityContext context, ILogger logger) : base(context, logger) { }
    }
}
