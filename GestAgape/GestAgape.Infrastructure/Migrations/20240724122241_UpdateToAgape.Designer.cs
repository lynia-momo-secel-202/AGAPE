...
namespace GestAgape.Infrastructure.Migrations
{
    ...
    [Migration("20240724122241_UpdateToAgape")]
    partial class UpdateToAgape
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestAgape.Core.Entities.Admission.DocDepose", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DocsDepose", "Admission");
                });
            ...
            modelBuilder.Entity("GestAgape.Core.Entities.Admission.FraisConcours", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("FraisConcours", "Admission");
                });

            modelBuilder.Entity("GestAgape.Core.Entities.Admission.FraisEtudeDossier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("FraisEtudeDossier", "Admission");
                });
            ...
            modelBuilder.Entity("GestAgape.Core.Entities.Parametrage.DocADepose", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DocsADepose", "Settings");
                });

            modelBuilder.Entity("GestAgape.Core.Entities.Parametrage.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GestAgape.Core.Entities.Scolarite.Bourse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Bourses", "Scolarite");
                });

            modelBuilder.Entity("GestAgape.Core.Entities.Scolarite.ChangementFiliereOrCampus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MotifChangement")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NextCampus")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NextFiliere")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PastCampus")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PastFiliere")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("Changements", "Scolarite");
                });
            ...
            modelBuilder.Entity("GestAgape.Core.Entities.Scolarite.FraisDossierExamen", b =>
                {
                    ...
                    b.ToTable("FraisDossierExamen", "Scolarite");
                });
            ...
            modelBuilder.Entity("GestAgape.Core.Entities.Admission.DocDepose", b =>
                {
                    ...
                    b.HasOne("GestAgape.Core.Entities.Parametrage.Document", "Document")
                        .WithMany()
            ...
            modelBuilder.Entity("GestAgape.Core.Entities.Parametrage.Document", b =>
                {
                    b.HasOne("GestAgape.Core.Entities.Parametrage.Document", null)
                        .WithMany("Documents")
                        .HasForeignKey("DocumentId");
                });
            ...
            modelBuilder.Entity("GestAgape.Core.Entities.Parametrage.Classe", b =>
                {
                    ...
                    b.Navigation("DocADeposes");

                    b.Navigation("FraisInscriptions");
                });
            ...
            modelBuilder.Entity("GestAgape.Core.Entities.Scolarite.Inscription", b =>
                {
                    b.Navigation("Bourses");

                    b.Navigation("Changements");
