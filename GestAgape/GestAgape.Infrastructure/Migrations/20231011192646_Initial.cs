        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Handicape = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    CurriculumVitae = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistredDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LatestModificationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Connexions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Connexions_User_UserID",
                        column: x => x.UserID,
                        principalSchema: "Identity",
                        principalTable: "User",
                        principalColumn: "Id");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PasswordHistories_User_UserID",
                        column: x => x.UserID,
                        principalSchema: "Identity",
                        principalTable: "User",
                        principalColumn: "Id");
